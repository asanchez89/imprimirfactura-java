...
public class Factura {
	...
	private BigDecimal alquilerDescuento;
	private BigDecimal alquilerReintegro;
	...
	public BigDecimal getAlquilerDescuento() {
		return alquilerDescuento;
	}

	public void setAlquilerDescuento(BigDecimal alquilerDescuento) {
		this.alquilerDescuento = alquilerDescuento;
	}

	public BigDecimal getAlquilerReintegro() {
		return alquilerReintegro;
	}

	public void setAlquilerReintegro(BigDecimal alquilerReintegro) {
		this.alquilerReintegro = alquilerReintegro;
	}
	...
	public String toString() {
		return "Factura [idFactura=" + idFactura + ", seqFactura=" + seqFactura + ", idEstadoCuenta=" + idEstadoCuenta
				...
				+ seguroDescuento + ", seguroReintegro=" + seguroReintegro + ", alquilerDescuento=" + alquilerDescuento
				+ ", alquilerReintegro=" + alquilerReintegro + ", totalPagado=" + totalPagado + ", conceptos="
